// ICPFilter.java
// $Id: ICPFilter.java,v 1.2 1997/03/27 13:57:52 cvs Exp $
...
public class ICPFilter implements PropRequestFilter, PropertyMonitoring {
    ...
    DEBUG_P = "w3c.www.protocol.http.icp.debug";
    /**
     * Properties - Our configuration file.
     */
    public static final String
    CONFIG_P = "w3c.www.protocol.http.icp.config";
    /**
     * Properties - Our own UDP port number.
     */
    public static final String
    PORT_P = "w3c.www.protocol.http.icp.port";
    /**
     * Properties - Our default timeout value.
     */
    public static final String
    TIMEOUT_P = "w3c.www.protocol.http.icp.timeout";
    /**
     * Properties - disable caching when fetching from a neighbour proxy.
     */
    public static final String
    DISABLE_CACHE_P = "w3c.www.protocol.http.icp.disable-cache";
    /**
     ...
     * @exception FilterInitException If the filter cannot launch its server
