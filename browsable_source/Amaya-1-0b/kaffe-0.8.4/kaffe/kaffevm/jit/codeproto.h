...
void _fixup_function_call(uintp, uintp);
...
void softcall_initialise_class(Class*);
...
void softcall_new(SlotInfo*, Class*);
void softcall_newarray(SlotInfo*, SlotInfo*, int);
void softcall_anewarray(SlotInfo*, SlotInfo*, Class*);
void softcall_athrow(SlotInfo*);
void softcall_checkcast(SlotInfo*, Class*);
void softcall_instanceof(SlotInfo*, SlotInfo*, Class*);
void softcall_monitorenter(SlotInfo*);
void softcall_monitorexit(SlotInfo*);
void softcall_multianewarray(SlotInfo*, int, SlotInfo*, Class*);
