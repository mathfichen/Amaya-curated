...
#define	call(m)					virtualMachine((methods*)(m)[0].v.taddr, sp, retval)
#define	ret()					goto end
...
#define	softcall_checkcast(o, t)		soft_checkcast(t, (o)->v.taddr)
#define softcall_get_method_code(r, m)		softcall_initialise_class (method_class ()); \
						((r)[0] = (m)[0])
#define softcall_get_method_code_const(r, m)	softcall_initialise_class (method_class ()); \
						((r)->v.taddr = (void*)(m))
