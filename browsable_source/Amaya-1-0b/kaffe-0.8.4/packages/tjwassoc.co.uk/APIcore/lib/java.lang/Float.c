...
extern double java_lang_Double_valueOf0(struct Hjava_lang_Double*, struct Hjava_lang_String*);
...
java_lang_Float_valueOf(struct Hjava_lang_Float* none, struct Hjava_lang_String* str)
{
	...
	obj = (struct Hjava_lang_Float*)execute_java_constructor(0, "java.lang.Float", 0, VOID_SIGNATURE);
	unhand(obj)->value = java_lang_Double_valueOf0((struct Hjava_lang_Double*)none, str);
	return (obj);
}
