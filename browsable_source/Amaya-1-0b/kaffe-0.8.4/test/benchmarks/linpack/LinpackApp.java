...
class LinpackClass {
    ...
    String applet_version = "LinpackJavaV2.0";
...
public class LinpackApp {

    public static void main(String args[]) {
	LinpackClass l = new LinpackClass();

        l.run_benchmark();
	System.out.println("Mflop/s: " + l.mflops_result + "  Time: " + l.time_result + " secs" + "  Norm Res: " + l.residn_result + "  Precision: " + l.eps_result);
    }
}
