/*                                      W3C Reference Library libwww Persistent Cache Manager
                  DECLARATION OF W3C REFERENCE PERSISTENT CACHE MANAGER
...
/*
   ...
   The cache contains details of persietent files which contain the contents of remote
   documents. The existing cache manager is somewhat naive - especially in its garbage
   collection but it is just an example of how it can be done. More advanced
...
/*
   ...
   ___________________________________
                           ...
                           @(#) $Id: WWWCache.h,v 1.1.1.1 1996/10/15 13:08:39 cvs Exp $
