/*                                                 W3C Reference Library libwww STYLE MANAGER
...
OVERRIDING THIS MODULE
   ...
   If it _is_ common code, then both the hypertext object and HTStyle.c must know the
...
/*
   ...
   ___________________________________
                           ...
                           @(#) $Id: HTStyle.h,v 1.1.1.1 1996/10/15 13:08:40 cvs Exp $
