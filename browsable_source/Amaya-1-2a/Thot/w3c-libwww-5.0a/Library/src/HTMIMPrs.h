/*                                  W3C Reference Library libwww MIME header parser managment
                                       MIMEPARSESET
...
/*
   ...
   A MIMEParseSetassociates simple and regex MIME header tokens with parsers. Regex tokens
   are stored in a list, while simple tokens are stored in a hashed list for quick access.
   
   This module is implemented by HTMIMPrs.c, and it is a part of the W3C Reference
   Library.
...
DATA TYPES
   ...
   The HTMIMEParseSet contains all registered MIME parses. There are regex parsers, which
   are stored in a list of HTMIMEParseEl, and simple (no wildcards) parsers stored in a
   hashed array of lists of HTMIMEParseEl.
...
extern HTMIMEParseSet_deleteAll (HTMIMEParseSet * me);
/*
...
/*
  ...
  Execute these parsers
   ...
   Find HTParserCallbackwhich matches the string.
...
/*
   ...
   ___________________________________
                           ...
                           @(#) $Id: HTMIMPrs.h,v 1.1.1.1 1996/10/15 13:08:40 cvs Exp $
