/*                               W3C Reference Library libwww Unbuffered Socket Writer Stream
...
/*
   ...
   The Socket Writer Stream is an output stream which knows how to write to a BSD type
   socket. It is part of the Transport interface and may be registered as part of a
   Transport Object. The application can initialize this stream together with the HTReader
   ...
   unbuffered socket write operations. See also the buffered writer stream.
...
/*
   ...
   ___________________________________
                          ...
                          @(#) $Id: HTWriter.h,v 1.1.1.1 1996/10/15 13:08:40 cvs Exp $
