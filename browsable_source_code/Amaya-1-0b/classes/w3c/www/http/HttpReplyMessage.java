...
// $Id: HttpReplyMessage.java,v 1.2 1997/03/27 13:57:40 cvs Exp $
...
public class HttpReplyMessage extends HttpEntityMessage {
    ...
    public static int H_ACCEPT_RANGES       = 43;
    public static int H_AGE                 = 44;
    public static int H_LOCATION            = 45;
    public static int H_PROXY_AUTHENTICATE  = 46;
    public static int H_PUBLIC              = 47;
    public static int H_RETRY_AFTER         = 48;
    public static int H_SERVER              = 49;
    public static int H_VARY                = 50;
    public static int H_WARNING             = 51;
    public static int H_WWW_AUTHENTICATE    = 52;
	...
	buf.append(' ');
	buf.append((reason != null) ? reason : "Unknowed Status Code");
	buf.append('\r');
	buf.append('\n');
	buf.emit(out);
    }
     ...
     * @param location The location, or <strong>null</strong> to reset the 
     * value.
     */
