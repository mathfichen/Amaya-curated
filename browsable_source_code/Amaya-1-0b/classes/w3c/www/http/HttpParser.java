// HttpParser.java
// $Id: HttpParser.java,v 1.2 1997/03/27 13:57:40 cvs Exp $$
...
public class HttpParser {
     ...
     * @exception HttpParserException To indicate the error to caller.
     */
	...
	if ( debug ) 
	    System.out.println("nextItem = ["+new String(buf, 0, ps.start, ps.end-ps.start)+"]");
