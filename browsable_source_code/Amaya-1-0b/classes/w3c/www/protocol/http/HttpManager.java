// HttpManager.java
// $Id: HttpManager.java,v 1.3 1997/04/01 15:46:25 cvs Exp $
...
public class HttpManager implements PropertyMonitoring {
    ...
    String DEFAULT_SERVER_CLASS = "w3c.www.protocol.http.HttpBasicServer";

    /**
     * The name of the property indicating the class of HttpServer to use.
     */
    public static final
    String SERVER_CLASS_P = "w3c.www.protocol.http.server";

    /**
     * The name of the property containing the ProprequestFilter to launch.
     */
    public static final 
    String FILTERS_PROP_P = "w3c.www.protocol.http.filters";
    /**
     * The maximum number of simultaneous connections.
     */
    public static final
    String CONN_MAX_P = "w3c.www.protocol.http.connections.max";
    /**
     * Header properties - The allowed drift for getting cached resources.
     */
    public static final 
    String MAX_STALE_P = "w3c.www.protocol.http.cacheControl.maxStale";
    /**
     * Header properties - The minium freshness required on cached resources.
     */
    public static final
    String MIN_FRESH_P = "w3c.www.protocol.http.cacheControl.minFresh";
    /**
     * Header properties - Set the only if cached flag on requests.
     */
    public static final 
    String ONLY_IF_CACHED_P="w3c.www.protocol.http.cacheControl.onlyIfCached";
    /**
     * Header properties - Set the user agent.
     */
    public static final 
    String USER_AGENT_P = "w3c.www.protocol.http.userAgent";
    /**
     * Header properties - Set the accept header.
     */
    public static final 
    String ACCEPT_P = "w3c.www.protocol.http.accept";
    /**
     * Header properties - Set the accept language.
     */
    public static final 
    String ACCEPT_LANGUAGE_P = "w3c.www.protocol.http.acceptLanguage";
    /**
     * Header properties - Set the accept encodings.
     */
    public static final 
    String ACCEPT_ENCODING_P = "w3c.www.protocol.http.acceptEncoding";
    /**
     ...
     */
    public static final
    String DEFAULT_USER_AGENT = "Jigsaw/1.0a5";
	...
	if ( name.equals(FILTERS_PROP_P) ) {
	    ...
	    return true;
	} else if ( name.equals(ONLY_IF_CACHED_P) ) {
	...
	manager.factory = new ReplyFactory();
    ...
    protected synchronized HttpServer lookupServer(String host, int port)
     ...
     * <code>w3c.www.http.maxConnections</code> property.
     ...
     * <code>w3c.www.http.proxy</code> property is defined, it will be
     ...
     * <code>w3c.www.http.requestTimeout</code> property value.
     ...
     * This can only be called from this package. The caller must rather
     * use the <code>getManager</code> method.
