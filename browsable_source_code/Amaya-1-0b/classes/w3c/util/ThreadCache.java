// ThreadCache.java
// $Id: ThreadCache.java,v 1.2 1997/03/27 13:57:33 cvs Exp $
...
public class ThreadCache {
     ...
     */
    protected CachedThread buzylist = null;
    /**
     ...
     * @return A CachedThread instance, or <strong>null</strong> if unable to 
	...
	// We are about to return a thread, mark it buzy:
	t.next   = buzylist;
	buzylist = t;
	return t;
    }
	...
	while ( true ) {
		...
		if ( debug ) 
		    System.out.println("*** no thread avail for "+runnable);
		return false;
	    }
	}
    }
