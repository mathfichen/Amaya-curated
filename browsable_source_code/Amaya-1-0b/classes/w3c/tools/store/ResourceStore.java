// ResourceStore.java
// $Id: ResourceStore.java,v 1.2 1997/03/27 13:57:30 cvs Exp $
...
public interface ResourceStore {
     ...
     * @param holder The object willing to hold a refernce to the store.
     */

    public void addHolder(ResourceStoreHolder holder);

    /**
     * Remove a store holder.
     * Notify the store that the given holder will no longer hold a reference
     * to that store.
     * @param holder The holder that is unsubscribing.
     */

    public void removeHolder(ResourceStoreHolder holder);
