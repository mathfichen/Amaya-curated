...
**	@(#) $Id: HTBInit.c,v 1.1.1.1 1996/10/15 13:08:37 cvs Exp $
**
...
PUBLIC void HTFileInit (void)
{
    ...
    HTBind_add("gtar",	"application/x-gtar",		NULL,	"binary",	NULL,	1.0);	/* Gnu tar		*/
    ...
    HTBind_add("latex",	"application/x-latex",		NULL,	"8bit",		NULL,	1.0);	/* LaTeX source		*/
    ...
    HTBind_add("rtf",	"application/x-rtf",		NULL,	"7bit",		NULL,	1.0);	/* RTF			*/
    ...
    HTBind_add("tex",	"application/x-tex",		NULL,	"8bit",		NULL,	1.0);	/* TeX source		*/
    HTBind_add("texi",	"application/x-texinfo",	NULL,	"7bit",		NULL,	1.0);	/* Texinfo		*/
    HTBind_add("texinfo","application/x-texinfo",	NULL,	"7bit",		NULL,	1.0);
    ...
    HTBind_add("zip",	 NULL,				"zip",	NULL,		NULL,	1.0);	/* PKZIP		*/
    HTBind_add("Z",	 NULL,				"compress",NULL,	NULL,	1.0);	/* Compressed data	*/
