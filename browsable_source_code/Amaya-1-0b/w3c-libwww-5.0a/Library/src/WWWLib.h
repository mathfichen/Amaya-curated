/*                                        W3C Reference Library libwww Basic libwww Interface
...
GENERAL UTILITIES
   ...
   The Basic Utility interface is mostly container modules, dynamic strings and other
   stuff that you can't live without when building applications. The modules are used by
   the core part of the W3C Reference Library but can also be used by the application.
...
/*
   ...
   ___________________________________
                            ...
                            @(#) $Id: WWWLib.h,v 1.1.1.1 1996/10/15 13:08:38 cvs Exp $
