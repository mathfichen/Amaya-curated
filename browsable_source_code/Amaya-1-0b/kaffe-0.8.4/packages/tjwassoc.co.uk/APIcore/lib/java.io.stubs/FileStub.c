...
{
	extern jint /* bool */ java_io_File_exists0(void*);
	jint /* bool */ ret = java_io_File_exists0(_P_[0].p);
	return_int(ret);
}
...
{
	extern jint /* bool */ java_io_File_canWrite0(void*);
	jint /* bool */ ret = java_io_File_canWrite0(_P_[0].p);
	return_int(ret);
}
...
{
	extern jint /* bool */ java_io_File_canRead0(void*);
	jint /* bool */ ret = java_io_File_canRead0(_P_[0].p);
	return_int(ret);
}
...
{
	extern jint /* bool */ java_io_File_isFile0(void*);
	jint /* bool */ ret = java_io_File_isFile0(_P_[0].p);
	return_int(ret);
}
...
{
	extern jint /* bool */ java_io_File_isDirectory0(void*);
	jint /* bool */ ret = java_io_File_isDirectory0(_P_[0].p);
	return_int(ret);
}
...
{
	extern jint /* bool */ java_io_File_mkdir0(void*);
	jint /* bool */ ret = java_io_File_mkdir0(_P_[0].p);
	return_int(ret);
}
...
{
	extern jint /* bool */ java_io_File_renameTo0(void*, void*);
	jint /* bool */ ret = java_io_File_renameTo0(_P_[1].p, _P_[0].p);
	return_int(ret);
}
...
{
	extern jint /* bool */ java_io_File_delete0(void*);
	jint /* bool */ ret = java_io_File_delete0(_P_[0].p);
	return_int(ret);
}
...
{
	extern jint /* bool */ java_io_File_isAbsolute(void*);
	jint /* bool */ ret = java_io_File_isAbsolute(_P_[0].p);
	return_int(ret);
}
