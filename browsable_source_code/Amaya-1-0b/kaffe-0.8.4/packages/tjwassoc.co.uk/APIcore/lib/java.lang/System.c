 ...
 */
void
java_lang_System_setIn0(struct Hjava_lang_System* none, struct Hjava_io_InputStream* stream)
{
	((struct Hjava_io_InputStream**)(SystemClass->staticData))[0] = stream;
}
 ...
 */
void
java_lang_System_setOut0(struct Hjava_lang_System* none, struct Hjava_io_PrintStream* stream)
{
	((struct Hjava_io_PrintStream**)(SystemClass->staticData))[1] = stream;
}
 ...
 */
void
java_lang_System_setErr0(struct Hjava_lang_System* none, struct Hjava_io_PrintStream* stream)
{
	((struct Hjava_io_PrintStream**)(SystemClass->staticData))[2] = stream;
}
