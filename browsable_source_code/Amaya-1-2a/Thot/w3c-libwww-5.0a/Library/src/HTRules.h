/*                               W3C Reference Library libwww Rule File Configuration manager
...
/*
   ...
   is not used by the Library at all and is part of the Application interface.
...
PARSE A WHOLE RULE FILE
   ...
   type for rule files called WWW_RULESin HTFormat.
...
PARSE A SINGLE LINE FROM A RULES FILE
   ...
   the rule file, for example INI files for X resources. configis a string in the syntax
   of a rule file line.
...
ADD A RULE TO THE LIST
   ...
   This function adds a rule to the list of rules. The patternis a 0-terminated string
   containing a single "*". equivpoints to the equivalent string with * for the place
...
/*
   ...
   ___________________________________
                           ...
                           @(#) $Id: HTRules.h,v 1.1.1.1 1996/10/15 13:08:40 cvs Exp $
