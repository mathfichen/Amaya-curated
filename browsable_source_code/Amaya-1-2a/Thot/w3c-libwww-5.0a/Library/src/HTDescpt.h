/*                                             W3C Reference Library libwww File descriptions
                                    FILE DESCRIPTIONS
...
/*
   ...
   This module is implemented by HTDescpt.c, and it is a part of the W3C Reference
   Library.
...
DESCRIPTION FILE
   ...
   HTDescriptionFilein the same directory as the directoy to be listed. The default value
   is .www_descript:
...
/*
   ...
   description files to contain also other information. An example of the format of the
   description file is:
...
/*
   ...
   itself (to get the HTML TITLE, for example). If formatis WWW_HTMLand description is not
   found, this module may be configured to use the HTML TITLE as the description.
...
/*
   ...
   ___________________________________
                          ...
                          @(#) $Id: HTDescpt.h,v 1.1.1.1 1996/10/15 13:08:40 cvs Exp $
