...
/*
   ...
   applications. See also the public part of the declarition in the HTResponse Module.
   
   This module is implemented by HTResMan.c, and it is a part of the W3C Reference
   Library.
...
/*
  ...
  Retry Request After
   ...
   If we get a response back saying that we have to retry the request after a certain
   amount of time then add this information here. Libwww does not retry the request
   automatically - this is for the application to do.
...
/*
  ...
  Access Authentication Information
   ...
   The challengeand the credentialsentries are use by the authentication parsers and
...
/*
  ...
  Connection Control Directives
   ...
   This association list is a list of the connection control directives that have been
...
/*
  ...
  Protocol Extension Protocol (PEP) Information
   ...
   These association lists contain the information that we have received in PEP headers in
   the response.
...
/*
  ...
  Cache Control Directives
   ...
   as part of the response. We also keep track of whether the response si cachable or not.
...
/*
  ...
  Range Requests
   ...
   We may get a partial response in which case we register the received ranges of the
   resource.
...
/*
  ...
  Variants
   ...
   The response may be a negotiated response in which case we wanna know. This has
   significance for whether the object is cachable or not.
...
/*
  ...
  Content Length
   ...
   We register the content length as thjis is of importance to all responses. The content
   length is a common way to figure out how many bytes we can expect.
...
/*
  ...
  Content Type
   ...
   The Content type is important to know as we set of the stream pipe and do the format
   conversion.
 ...
 */
    HTEncoding         transfer_encoding;
/*

  Original Reponse Header Values
  
   We store the original headers as they may become useful in many ways - for example in
   lazy parsing.
...
/*
   ...
   ___________________________________
                           ...
                           @(#) $Id: HTResMan.h,v 1.1.1.1 1996/10/15 13:08:41 cvs Exp $
